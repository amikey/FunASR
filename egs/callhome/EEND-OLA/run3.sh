    ...
    for ((i = 0; i < $gpu_num; ++i)); do
        {
            ...
            eend_old_diar_train.py \
                ...
                --dataset_type eend_ola \
                --data_path_and_name_and_type ${simu_feats_dir}/${simu_train_dataset}/feats_2spkr.scp \
                --data_path_and_name_and_type ${simu_feats_dir}/${simu_valid_dataset}/feats_2spkr.scp \
                --resume true \
