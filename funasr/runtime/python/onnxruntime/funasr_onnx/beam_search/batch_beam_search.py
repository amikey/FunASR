...
from funasr_onnx.beam_search.hyps import BatchHypothesis, Hypothesis
from funasr_onnx.utils.function import pad_sequence, topk
...
class BatchBeamSearch(BeamSearch):
    ...
    def score_full(
        ...
        for k, d in self.full_scorers.items():
            print("hyp.yseq {}".format(hyp.yseq.shape))
            print("hyp.states[k] list {}".format(len(hyp.states[k])))
